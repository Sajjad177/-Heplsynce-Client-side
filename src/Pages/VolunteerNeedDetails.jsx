...
const VolunteerNeedDetails = () => {
  ...
  const { title, thumbnail, description, category, location, number_Need, deadline } = volunteer || {};
        ...
        <div className="container flex flex-col mx-auto lg:flex-row">
          ...
          <div className="flex flex-col w-full p-6 lg:w-2/3 md:p-8 lg:p-12">
            <div className="flex items-center lg:flex-row  justify-between">
              ...
              <span className="border lg:p-2  rounded-full bg-yellow-950 border-none">{category}</span>
            </div>
